...
import './RightCardProduct.css'; 
import displayCOPCurrency from '../helpers/displayCurrency';
const  RightCardProduct = ({ category, heading }) => {
    ...
    return (
        <div className="vertical-card-container">
            <h2 className="vertical-card-heading">{heading || 'Productos de la Categoría'}</h2>
...
export default RightCardProduct;
