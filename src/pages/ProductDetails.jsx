...
const ProductDetails = () => {
  ...
  // Se encarga de validar el día seleccionado en la fecha
  const handleDateChange = (e) => {
    const newDateValue = e.target.value; // Formato YYYY-MM-DD
    const dayOfWeek = new Date(newDateValue).getDay(); 
    // getDay() -> 0:Domingo, 1:Lunes, 2:Martes, 3:Miércoles, 4:Jueves, 5:Viernes, 6:Sábado

    if (dayOfWeek === 2) { 
      // 2 es Martes
      alert('Lo sentimos, los martes estamos cerrados. Por favor elige otro día.');
      setSelectedDate(''); // Limpia el campo fecha
    } else {
                ...
                <form onSubmit={handleReservationSubmit}>
                  <div className="form-group">
                    ...
                    <input
                      ...
                      id="reservation-date"
                      value={selectedDate}
                      onChange={handleDateChange}  // Usamos la función que valida martes
                      min={todayDate}
                      required
                    />
                  </div>
                  <div className="form-group">
                    ...
                    <input
                      ...
                      required
                      min="09:00"   // Rango mínimo
                      max="13:00"   // Rango máximo (1:00 pm)
                    />
                  </div>
